...
function ImpactStats() {
  const stats = [
    ...
    { value: '97%', label: 'University Placement Rate' },
    { value: '95%', label: 'RPL Success Rate' },
    { value: '92%', label: 'Accelerated Progress Rate' },
  ];

  return (
    <div className="bg-[#fdf5ed] w-full py-16 px-4 md:px-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-center">
        {stats.map((stat, index) => (
          <div key={index}>
            <h3 className="text-5xl font-bold text-black mb-2">{stat.value}</h3>
