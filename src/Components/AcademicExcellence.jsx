...
import Guidance from "../assets/Home-Our Expertise-1.jpg";
import ProgramMatching from "../assets/Program-matching.jpg";
import Rpl from "../assets/RPL-Strategy.jpg";
import { GraduationCap, Globe, Clock, ChevronRight, Compass, Gift, Briefcase } from "lucide-react";
  ...
  const journeySteps = [
    {
      ...
      description: "We evaluate your qualifications and create a personalized education roadmap."
    },
    {
      icon: <GraduationCap className="text-green-700" size={24} />,
      title: "Program Matching",
      description: "We identify universities that maximize your credits and align with your career goals."
    },
    {
      icon: <Briefcase className="text-green-700" size={24} />,
      title: "Application Support",
      description: "From paperwork to interviews, we guide you through every step of the application process."
    },
    {
      icon: <Globe className="text-green-700" size={24} />,
      title: "Transition Assistance",
      description: "Pre-departure guidance and resources to ensure a smooth transition abroad."
    }
  ];

  const benefits = [
    { text: "Save up to 1-2 years on degree completion", icon: <Clock size={18} /> },
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row-reverse w-full items-center px-6 md:px-12 md:mb-16 gap-12">
          ...
          <div className="md:w-[50%] w-full">
            ...
            Embarking on an international or local education journey is a life-changing decision, and we’re here to make it rewarding and accessible. With <span className="font-bold text-green-600">GlobalEd Pathway</span>, you gain a trusted partner committed to your success. Let us help you turn your Singapore qualifications into a gateway for global opportunities, equipping you with the credentials and confidence to thrive in today’s competitive world.
            </p>
            
            {/* Benefits */}
            <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
              <h3 className="font-semibold text-xl mb-4 text-gray-800">Key Benefits</h3>
            ...
            <div className="relative">
              ...
              <div className="relative z-10 overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <p className="text-sm opacity-90">Our students achieve their academic dreams in less time</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="px-6 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Your Educational Journey With Us</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">We provide comprehensive support throughout your entire educational journey, from initial assessment to successful program completion.</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-800 rounded-2xl p-8 text-white text-center max-w-4xl mx-auto shadow-xl">
            ...
            <p className="mb-6 text-xl text-blue-100">Contact us today to explore your options and start building your future with a shorter, smarter path to higher education!</p>
