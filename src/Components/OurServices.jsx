...
export default function ConsultingServices() {
  ...
  const services = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">Swift admission process of your chosen institute. Apex Education Pathfinder is Singapore's leading source of information on opportunities for students to study . We will help you find the right course and university that is the best for you.</p>
          <p className="mb-4">At Apex Education Pathfinder Admission Consulting service, we don't just guide; we empower you to present the strongest possible application for your educational pursuits. Let us be your partner in achieving academic success and unlocking the doors to a promising future.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">Apex Education Pathfinder details its students with the visa procedure to be followed in the guides them in preparing the various documents required for obtaining a valid student visa. Sessions to provide an insight to the various facets of student life.</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-4">At Apex Education Pathfinder, our commitment goes beyond the initial stages of your journey. We are here to support you post-arrival, ensuring you have the resources and assistance needed for a successful and enriching experience in your new academic and cultural environment. Welcome to a new chapter of growth and exploration!</p>
        </div>
      )
    }
  ];
